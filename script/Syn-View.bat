...
echo %pro203m_cb%  | find "%project%" >nul && goto l_203m_cb
...
echo %pro301new%     | find "%project%" >nul && goto l_301new
echo %pro301c%    | find "%project%" >nul && goto l_301c
echo "error project" %project%
goto :End

:l_205
set "local_dir=D:\%project%\"
set "SIT=%SIT205%"
set "src=%src205%"
set "starTeam=%ST205%"
set "vxworks=%vw205%"
...
set "SIT=%SIT203m_cb%"
set "src=%src203m_cb%"
set "starTeam=%ST203m_cb%"
set "vxworks=%vw203m_cb%"
set "firmware=%fm203m_cb%"
goto checkout
...
:l_301new
set "local_dir=I:\SSB300\%project%\"
set "SIT=%SITvw301new%"
set "src=%srcvw301new%"
set "starTeam=%ST301new%"
set "vxworks=%vw301new%"
set "firmware=%fm301new%"
goto checkout
...
%CHECK_OUT% %starTeam%/"%project%/%vxworks%"  -fp "%local_dir%\%vxworks%" -is -o "*"
%CHECK_OUT% %starTeam%/"%project%/%firmware%"  -fp "%local_dir%\%firmware%" -is -o "*"
